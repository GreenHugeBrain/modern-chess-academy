      ...
      <Reveal>
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-ink/60 dark:text-ivory/60 mt-2">Sign in to continue training</p>
          </div>
          ...
          <div className="bg-white dark:bg-white/5 rounded-3xl border border-ink/10 dark:border-white/10 p-8 shadow-xl">
            ...
            <p className="mt-6 text-center text-sm text-ink/60 dark:text-ivory/60">
              ...
              <Link to="/register" className="text-emerald-700 dark:text-amber-400 font-semibold hover:underline">
                Start free
              </Link>
            </p>
          </div>
